...
public class Road extends JPanel{
    ...
    public void paintComponent(Graphics g) { //rahh
        ...
        g.fillRect(0, 0, (int) MyFrame.size.getWidth(), (int) 30);
        g.fillRect(0, this.getHeight() - 30, (int) MyFrame.size.getWidth(), (int) 30);

        g.setColor(new Color(255, 204, 51)); //dark grey
